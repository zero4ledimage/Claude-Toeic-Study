    ...
    try {
      const resp = await ApiClient.callClaude({
        ...
        system:
          ...
          "請用繁體中文回覆,依序輸出三個段落,分別以「【修正版】」「【升級版】」「【搭配詞檢查】」開頭:" +
          "【修正版】保留原意,只修正文法與用詞錯誤,並在後面用括號簡短說明修正原因;" +
          "【升級版】改寫成更接近目標分數水準的進階句型與詞彙,同樣保留原意;" +
          "【搭配詞檢查】(需求文件 3.11 功能五)找出文中不自然的搭配詞(collocation)," +
          "具體說明「這個字通常跟哪類詞一起出現、建議改用什麼字」;若沒有明顯問題就寫「無明顯不自然搭配」。" +
          "⚠️ 嚴禁編造任何頻率數字、倍數或語料庫統計(如 COCA 次數),只能用「常見/較不常見」這類相對描述。",
